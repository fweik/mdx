 ...
 */
  template<class Arg>
  using Negate = Unary<Tags::Negate, Arg>;
 ...
 */
  template<class Arg1, class Arg2>
  using Plus = Binary<Tags::Plus, Arg1, Arg2>;
 ...
 */
  template<class Arg1, class Arg2>
  using Power = Binary<Tags::Power, Arg1, Arg2>;
 ...
 */
  template<class... Expr>
  using Sum = Algorithms::right_fold<Plus, Expr...>;
...
namespace detail {
  template<class Arg>
  struct Eval<Expression::Negate<Arg>>
  {
  ...
  template<class Arg1, class Arg2>
  struct Eval<Expression::Plus<Arg1, Arg2>>
  {
    template<class T, class Args>
    static T eval(Args const &args)
    {
  ...
  template<class Arg1, class Arg2>
  struct Eval<Expression::Divides<Arg1, Arg2>>
  {
    template<class T, class Args>
    static T eval(Args const &args)
    {
